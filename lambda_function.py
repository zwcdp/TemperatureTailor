...
def get_welcome_response(context):
    ...
    # Get coordinates.
    coordinates = requests.get("http://ip-api.com/json/")
    latitude = coordinates.json()["lat"]
    longitude = coordinates.json()["lon"]
    
    # Future feature: more personalized responses?
    #city = coordinates.json()["city"]
    
    # Add GPS coords in Dark Sky API call.
    weather_output = requests.get("https://api.darksky.net/forecast/f3b60e3860754a0934693e5bbe7cf56e/" + str(latitude) + "," + str(longitude))
